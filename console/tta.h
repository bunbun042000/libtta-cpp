...
#define tta_seek_from_here(__handle,__offset) lseek64(__handle,__offset,SEEK_CUR)
...
#define tta_seek_from_here(__handle,__offset) SetFilePointer(__handle,(LONG)__offset,0,FILE_CURRENT)
